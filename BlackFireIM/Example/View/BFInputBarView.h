...
@class BFInputBarView;
/**
 *  输入条的回调委托
 *  本委托包含输入条各种情况下的对于各种事件的回调。
 */
@protocol BFInputBarViewDelegate <NSObject>
/**
 *  点击表情按钮，即“笑脸”后的回调委托。
 ...
 */
- (void)inputBarDidTouchFace:(BFInputBarView *_Nonnull)textView;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidTouchMore:(BFInputBarView *_Nonnull)textView;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidTouchVoice:(BFInputBarView *_Nonnull)textView;
 ...
 */
- (void)inputBar:(BFInputBarView *_Nonnull)textView didChangeInputHeight:(CGFloat)offset;
 ...
 */
- (void)inputBar:(BFInputBarView *_Nonnull)textView didSendText:(NSString *_Nullable)text;
 ...
 */
- (void)inputBar:(BFInputBarView *_Nonnull)textView didSendVoice:(NSString *_Nullable)path;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidInputAt:(BFInputBarView *_Nonnull)textView;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBar:(BFInputBarView *_Nonnull)textView didDeleteAt:(NSString *_Nullable)text;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidTouchKeyboard:(BFInputBarView *_Nonnull)textView;
