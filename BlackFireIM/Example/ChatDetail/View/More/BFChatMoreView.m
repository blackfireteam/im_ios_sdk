...
@interface BFChatMoreView()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_moreCollectionView registerClass:[BFInputMoreCell class] forCellWithReuseIdentifier:@"moreCell"];
...
- (void)defaultLayout
{
    CGSize cellSize = [BFInputMoreCell getSize];
...
{
    BFInputMoreCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"moreCell" forIndexPath:indexPath];
    BFInputMoreCellData *data;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(moreView:didSelectMoreCell:)]){
        if ([cell isKindOfClass:[BFInputMoreCell class]]) {
            [_delegate moreView:self didSelectMoreCell:(BFInputMoreCell *)cell];;
        }
    }
}
...
{
    return [BFInputMoreCell getSize];
}
