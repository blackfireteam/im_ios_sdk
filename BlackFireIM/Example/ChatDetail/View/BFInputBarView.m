...
#import "BFRecordView.h"
#import "NSFileManager+filePath.h"
#import "NSString+Ext.h"


@interface BFInputBarView()<UITextViewDelegate,AVAudioRecorderDelegate>

@property (nonatomic, strong) BFRecordView *record;
...
- (void)setupUI
{
    ...
    [_micButton setImage:[UIImage bf_imageNamed:@"ToolViewInputVoice"] forState:UIControlStateNormal];
    [_micButton setImage:[UIImage bf_imageNamed:@"ToolViewInputVoiceHL"] forState:UIControlStateHighlighted];
    ...
    [_faceButton setImage:[UIImage bf_imageNamed:@"ToolViewEmotion"] forState:UIControlStateNormal];
    [_faceButton setImage:[UIImage bf_imageNamed:@"ToolViewEmotionHL"] forState:UIControlStateHighlighted];
    ...
    [_keyboardButton setImage:[UIImage bf_imageNamed:@"ToolViewKeyboard"] forState:UIControlStateNormal];
    [_keyboardButton setImage:[UIImage bf_imageNamed:@"ToolViewKeyboardHL"] forState:UIControlStateHighlighted];
    ...
    [_moreButton setImage:[UIImage bf_imageNamed:@"TypeSelectorBtn_Black"] forState:UIControlStateNormal];
    [_moreButton setImage:[UIImage bf_imageNamed:@"TypeSelectorBtnHL_Black"] forState:UIControlStateHighlighted];
    ...
    _inputTextView = [[BFResponderTextView alloc] init];
...
- (void)recordBtnDown:(UIButton *)sender
{
    ...
    if(permission == AVAudioSessionRecordPermissionGranted){
        if(!_record){
            _record = [[BFRecordView alloc] init];
...
- (void)startRecord
{
    ...
    NSDictionary *recordSetting = [[NSDictionary alloc] initWithObjectsAndKeys:
                                   ...
                                   nil];
    NSString *fileName = [NSString stringWithFormat:@"%@.m4a",[NSString uuidString]];
    NSString *path = [[NSFileManager pathForIMVoice]stringByAppendingPathComponent:fileName];
