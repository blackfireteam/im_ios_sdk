...
@interface BFFaceView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_faceCollectionView registerClass:[BFFaceCollectionCell class] forCellWithReuseIdentifier:@"BFFaceCollectionCell"];
...
{
    BFFaceCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"BFFaceCollectionCell" forIndexPath:indexPath];
