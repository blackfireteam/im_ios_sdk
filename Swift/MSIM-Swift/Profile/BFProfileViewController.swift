...
class BFProfileViewController: BFBaseViewController {
    ...
    private func editNickName(name: String) {
        ...
        info?.nick_name = name
        ProfileService.userEditAPI(info: info!) { dic in
...
extension BFProfileViewController: UITableViewDataSource,UITableViewDelegate {
...
extension BFProfileViewController {
