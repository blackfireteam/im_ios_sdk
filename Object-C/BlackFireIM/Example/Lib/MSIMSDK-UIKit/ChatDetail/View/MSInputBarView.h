...
@class MSInputBarView;
/**
 *  输入条的回调委托
 *  本委托包含输入条各种情况下的对于各种事件的回调。
 */
@protocol MSInputBarViewDelegate <NSObject>
/**
 *  点击表情按钮，即“笑脸”后的回调委托。
 ...
 */
- (void)inputBarDidTouchFace:(MSInputBarView *_Nonnull)textView;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidTouchMore:(MSInputBarView *_Nonnull)textView;
 ...
 */
- (void)inputBar:(MSInputBarView *_Nonnull)textView didChangeInputHeight:(CGFloat)offset;
 ...
 */
- (void)inputBar:(MSInputBarView *_Nonnull)textView didSendVoice:(NSString *_Nullable)path;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBarDidInputAt:(MSInputBarView *_Nonnull)textView;
 ...
 *  @param textView 委托者，当前与用户交互的 InputBar。
 */
- (void)inputBar:(MSInputBarView *_Nonnull)textView didDeleteAt:(NSString *_Nullable)text;
...
@interface MSInputBarView : UIView
 ...
 *  继承自 UITextView
 */
@property(nonatomic,strong) MSResponderTextView *inputTextView;
